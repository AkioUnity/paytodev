...
class PublicController extends Controller
{
    ...
    {
        $random_number = Helper::generateRandomCode(30);
        $client = new GuzzleHttp\Client();
        $res = $client->get('https://pm.ineedadeveloper.com/index.php/signin/changeToken/'.$random_number.'?email='.Auth::user()->email);
        echo $res->getBody(); // { "type": "User", ....
        $url='https://pm.ineedadeveloper.com/index.php/signin/fromMain/'.$random_number;
