                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="wt-footerlogohold">
                            @if (!empty($footer['footer_logo']))
                                <strong class=""><a href="{{{ url('/') }}}"><img src="{{{ asset(\App\Helper::getFooterLogo($footer['footer_logo'])) }}}" alt="company logo here" style="width: 40%;" ></a></strong>
                                {{--<img src="{{{ asset(\App\Helper::getFooterLogo('eshs.png')) }}}" alt="company logo here" style="width: 20%;" >--}}
                                {{--<img src="{{{ asset(\App\Helper::getFooterLogo('usr0.png')) }}}" alt="company logo here" style="width: 20%;" >--}}
                            @endif
